...
experience in more practical fields, such as ML or bioinformatics.
%
...
%
We propose two new combinatorial algorithms for the multicommodity flow (MCF) problem, and tie their time complexity to properties of the MCF polyhedron. One of the algorithms stems from the Frank-Wolfe method, a projection-free convex optimisation method gaining popularity in ML.
%
...
moderately-sized instances optimally or almost optimally in a few seconds.
\bigstrut
\cr
}

{\bf Relevant courses:} I have taken Introduction to Computer Linguistics, Deep Learning and Introduction to Computer Graphics during my Bachelor's, currently taking Reliable and Trustworthy AI and Information Theory~I.
