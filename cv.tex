...
%
I love pushing the boundaries of human knowledge and creating what hasn't been
created before, especially in a group of similarly enthusiastic people.
%
...
%
Proved NP-hardness of a certain periodic scheduling problem, developed and tested several new heuristics for it, proposed a new method for generating problem instances. Primary author of the resulting conference paper.
\bigstrut
\cr
}
...
VST3, LV2 and JACK support written in \Cpp. Lets you sing chords in
real time using a MIDI keyboard and your voice, by analysing it and
resynthesising it at different pitches.

\sekce Programming languages \& technologies
 
{\let\bf\relax
Professionally worked with {\bf \Cpp} and {\bf Python}, also fluent in {\bf C},
{\bf sh} and \TeX. Worked with \Cis{} and Haskell at some point. Experience with
