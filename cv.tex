...
\: So far, achieved $\approx \hbox{\bf 200}\times$ {\bf speedup:} $25\times$ due to optimisations in the underlying algorithm and $8\times$ due to vectorisation, better cache locality, memory compaction etc.
\endlist
